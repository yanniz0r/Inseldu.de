...
const Hero: FC<HeroProps> = (props) => {
  return (
    <div className="relative h-screen lg:grid lg:grid-cols-2">
      <div className="relative z-10 flex h-screen w-full items-center bg-gray-100 bg-opacity-50 dark:bg-slate-800 dark:bg-opacity-90 lg:bg-opacity-100 dark:lg:bg-opacity-100">

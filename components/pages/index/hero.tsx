...
const Hero: FC<HeroProps> = (props) => {
  return (
    <div className="h-screen lg:grid lg:grid-cols-2 relative">
      <div className="flex h-screen items-center bg-gray-100 dark:bg-slate-800 w-full dark:bg-opacity-90 bg-opacity-50 dark:lg:bg-opacity-100 lg:bg-opacity-100 relative z-10">
        <div className="flex flex-col gap-5 px-10 lg:px-28">
          ...
          <div>
            <span className="text-5xl inline font-extrabold bg-gradient bg-gradient-to-r from-indigo-700 dark:from-indigo-500 to-emerald-400 leading-normal box-decoration-clone text-white p-1">
              Yannic Inselmann
            </span>
          </div>
      ...
      <div
        className="lg:static bg-center bg-cover lg:bg-cover absolute top-0 left-0 h-full w-full z-0 bg-fixed lg:bg-local"
